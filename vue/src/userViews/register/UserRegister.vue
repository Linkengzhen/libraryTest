<template>
  <div class="wrapper">
    <div style="margin: 100px auto; background-color: #fff; width: 350px; height: 500px; padding: 20px; border-radius: 10px">
      ...
      <div style="margin: 10px 0; text-align: center; font-size:16px"><b>读者注册</b></div>
      <el-form :model="user" :rules="rules" ref="userForm">
        ...
        <el-form-item prop="phone">
          <el-input placeholder="请输入联系方式" size="medium" style="margin: 5px 0" prefix-icon="el-icon-phone" v-model="user.phone"></el-input>
        </el-form-item>
        ...
        <el-form-item style="margin: 5px 0; text-align: center">
          <el-radio v-model="radio" label="1" @input="$router.push('/adminRegister')">管理员</el-radio>
        ...
        <el-form-item style="margin: 5px 0; text-align: right">
          ...
          <el-button type="warning" size="small"  autocomplete="off" @click="$router.push('/userLogin')">返回登录</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
